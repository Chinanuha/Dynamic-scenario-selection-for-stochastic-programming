function [R2,r,w,Func_Time,cvx_Time] = RiskImpSampling(Info,RR,S)
...
t1 = clock;
NAssets = size(RR,2); % Number of assests
N = size(RR,1); % Number of scenarios
...
C = max(Info.L-Info.B*RR*x,0);
C_bar = mean(max(Info.L-Info.B*RR*x,0));
w = C/(N*C_bar);
% ================================================================================
